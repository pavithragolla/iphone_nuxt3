import { getCurrentInstance, inject, computed, defineComponent, provide, h, Suspense, Transition, reactive, defineAsyncComponent, isRef, toRef, ref, resolveComponent, watchEffect, markRaw, shallowRef, useSSRContext, createApp, onErrorCaptured, unref, withCtx, createVNode } from 'file://C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/node_modules/ohmyfetch/dist/node.mjs';
import { joinURL, hasProtocol, isEqual, parseURL } from 'file://C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/node_modules/ufo/dist/index.mjs';
import { createHooks } from 'file://C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/node_modules/unctx/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter } from 'file://C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sendRedirect } from 'file://C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/node_modules/h3/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/node_modules/defu/dist/defu.mjs';
import { isFunction } from 'file://C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/node_modules/@vue/shared/index.js';
import { ssrRenderSuspense, ssrRenderComponent } from 'file://C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/node_modules/vue/server-renderer/index.mjs';
...
const appHead = { "meta": [], "link": [], "style": [], "script": [], "noscript": [], "title": "nuxt3 course", "charset": "utf-8", "viewport": "width=device-width, initial-scale=1" };
...
const meta$4 = void 0;
const meta$3 = void 0;
const useCart = () => useState(() => [], "$vuSkebpfZQ");
const useAuth = () => useState(() => ({
  isAuthenticated: false
}), "$e2S2C1cBHg");
const usePageVisitCount = () => useState(() => 0, "$U5p6uvu2r8");
const meta$2 = void 0;
const meta$1 = void 0;
const meta = {
  layout: "sidebar",
...
const _routes = [
  {
    name: "about",
    path: "/about",
    file: "C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/pages/about.vue",
    children: [],
    meta: meta$5,
    alias: (meta$5 == null ? void 0 : meta$5.alias) || [],
    component: () => import('./about.8a9702fb.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    file: "C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/pages/index.vue",
    children: [],
    meta: meta$4,
    alias: [],
    component: () => import('./index.d872a430.mjs').then((m) => m.default || m)
  },
  {
    name: "iphone",
    path: "/iphone",
    file: "C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/pages/iphone/index.vue",
    children: [],
    meta: meta$3,
    alias: [],
    component: () => import('./index.f4d2acb7.mjs').then((m) => m.default || m)
  },
  {
    name: "iphone-iphonename",
    path: "/iphone/iphone:name",
    file: "C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/pages/iphone/iphone[name].vue",
    children: [],
    meta: meta$2,
    alias: [],
    component: () => import('./iphone_name_.4521a74b.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    file: "C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/pages/login.vue",
    children: [],
    meta: meta$1,
    alias: [],
    component: () => import('./login.4756a3af.mjs').then((m) => m.default || m)
  },
  {
    name: "profile",
    path: "/profile",
    file: "C:/Users/Nspira/documents/nuxt3apps/nuxt3iphone/pages/profile.vue",
    children: [],
    meta,
    alias: (meta == null ? void 0 : meta.alias) || [],
    component: () => import('./profile.01eef5c1.mjs').then((m) => m.default || m)
  }
];
...
const page_45visit_45global = defineNuxtRouteMiddleware(() => {
  const pageVisitCount = usePageVisitCount();
  pageVisitCount.value++;
  console.log("global");
});
const globalMiddleware = [
  page_45visit_45global
];
const namedMiddleware = {
  auth: () => import('./auth.e2e04f78.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.4f146529.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: defineAsyncComponent(() => import('./default.0af1be13.mjs').then((m) => m.default || m)),
  sidebar: defineAsyncComponent(() => import('./sidebar.7d0d1e9d.mjs').then((m) => m.default || m))
};
...
export { _export_sfc as _, __nuxt_component_0$1 as a, useRoute as b, useCart as c, defineNuxtRouteMiddleware as d, entry$1 as default, useAuth as e, usePageVisitCount as f, useHead as u };
